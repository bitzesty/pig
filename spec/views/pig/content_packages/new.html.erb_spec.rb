...
module Pig
  RSpec.describe "pig/admin/content_packages/new", type: :view do
    it "should order requested by surname, regardless of role" do
      user_c = FactoryBot.create(:user, :admin, last_name: 'C', first_name: 'C')
      user_b = FactoryBot.create(:user, :admin, last_name: 'B', first_name: 'B')
      user_a = FactoryBot.create(:user, :admin, last_name: 'A', first_name: 'A')
